...
public class DefinitionStep_FinUA {
   ...
   @Steps
    ...
    public void whenUserSwitchToEURRates(){steps_finUa.switchToEUERates();}

    @Then("'EUR' rates are shown")
    public void thenEURExchangeratesAREShown(){steps_finUa.checkThatEURRatesIsSelected();}
    ...
    public void verifyCalculation_EUR_OPTM_BID(){steps_finUa.verifyCalculation_EUR_OPTM_BID();}

    @Then ("optimal value of ASK rate in summary table is equal to minimum value of ASK rate in summary table")
    public void verifyCalculation_EUR_OPTM_ASK (){steps_finUa.verifyCalculation_EUR_OPTM_ASK();}
